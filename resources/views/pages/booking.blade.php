            ...
            <form method="POST" action="{{ route('booking.store') }}" id="mkt-booking-form">
                ...
                <div class="mkt-detail">
                    <div class="mkt-panel">
                        ...
                        <div class="mkt-field">
                            <label>Email <span style="color:#999;font-weight:400">(optional)</span></label>
                            <input class="mkt-input" type="email" name="email" value="{{ old('email', auth()->user()->email ?? '') }}">
                        </div>
                        <div class="mkt-field">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    veh.addEventListener('change', calc);
    calc();
});
</script>
@endpush
